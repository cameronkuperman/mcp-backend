-- Long-term Symptom Tracking Database Tables
-- Enables users to track symptoms over time with AI-suggested metrics
...
CREATE INDEX idx_suggestions_active ON tracking_suggestions (user_id, viewed_at) WHERE actioned_at IS NULL AND expires_at > NOW();
