-- Assessment Follow-Up System Migration (FIXED VERSION)
...
-- FIXED: Uses unique index names to avoid conflicts with existing tables
...
CREATE INDEX IF NOT EXISTS idx_assessment_follow_ups_chain ON assessment_follow_ups(chain_id, follow_up_number);
CREATE INDEX IF NOT EXISTS idx_assessment_follow_ups_user ON assessment_follow_ups(user_id, created_at DESC);
CREATE INDEX IF NOT EXISTS idx_assessment_follow_ups_source ON assessment_follow_ups(source_type, source_id);
CREATE INDEX IF NOT EXISTS idx_assessment_follow_ups_parent ON assessment_follow_ups(parent_follow_up_id) WHERE parent_follow_up_id IS NOT NULL;
CREATE INDEX IF NOT EXISTS idx_assessment_follow_ups_confidence ON assessment_follow_ups(confidence_score DESC);
CREATE INDEX IF NOT EXISTS idx_assessment_follow_ups_urgency ON assessment_follow_ups(urgency_level, created_at DESC);
CREATE INDEX IF NOT EXISTS idx_assessment_follow_ups_created ON assessment_follow_ups(created_at DESC);

CREATE INDEX IF NOT EXISTS idx_follow_up_events_chain ON follow_up_events(chain_id, event_timestamp);
CREATE INDEX IF NOT EXISTS idx_follow_up_events_follow_up ON follow_up_events(follow_up_id, event_timestamp);
CREATE INDEX IF NOT EXISTS idx_follow_up_events_user ON follow_up_events(user_id, event_timestamp DESC);
CREATE INDEX IF NOT EXISTS idx_follow_up_events_type ON follow_up_events(event_type, event_timestamp DESC);

CREATE INDEX IF NOT EXISTS idx_medical_visits_user ON medical_visits(user_id, visit_date DESC);
CREATE INDEX IF NOT EXISTS idx_medical_visits_follow_up ON medical_visits(follow_up_id);
CREATE INDEX IF NOT EXISTS idx_medical_visits_date ON medical_visits(visit_date DESC);

CREATE INDEX IF NOT EXISTS idx_follow_up_schedules_user ON follow_up_schedules(user_id, scheduled_date);
CREATE INDEX IF NOT EXISTS idx_follow_up_schedules_date ON follow_up_schedules(scheduled_date) WHERE status = 'scheduled';
CREATE INDEX IF NOT EXISTS idx_follow_up_schedules_chain ON follow_up_schedules(chain_id);

-- Create composite indexes for common query patterns
CREATE INDEX IF NOT EXISTS idx_assessment_follow_ups_user_chain ON assessment_follow_ups(user_id, chain_id, follow_up_number);
CREATE INDEX IF NOT EXISTS idx_assessment_follow_ups_temporal ON assessment_follow_ups(chain_id, days_since_original);
